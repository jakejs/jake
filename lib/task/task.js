...
TaskBase = new (function () {
  ...
  this.handlePrereqComplete = function (prereq) {
    ...
    prereq.removeListener('complete', this.handlePrereqComplete);
    prereq.removeListener('skip', this.handlePrereqComplete);
