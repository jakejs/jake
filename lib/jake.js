...
var JAKE_VERSION = '0.1.12'
  ...
  , exists
  , tasks
  ,utils_dir = "/usr/local/lib/node_modules/jake/utils/";
...
usage = ''
    ...
    + '  -u, --utils              	Change to "utils_dir" directory before running tasks. When no parameter, pass current directory\n'
    + '';
...
if (opts.utils) {
  dirname = utils_dir;
  if(cmds.length == 0) cmds.push(process.cwd());
}
