...
var fs = require('fs');
var Task = require('./task/task').Task;
var Matcher;
var rule = {};
var Rule;
...
Rule.prototype = new (function () {
  ...
  this.createTask = function (fullName, level) {
    ...
    var tNs;
    var createdTask;
    var name = Task.getBaseTaskName(fullName);
    var nsPath = Task.getBaseNamespacePath(fullName);
    var ns = this.ns.resolveNamespace(nsPath);
