...
NpmPublishTask.prototype = new (function () {
  ...
  this.define = function () {
    ...
    namespace('npm', function () {
      ...
      task('version', ['ensureClean', 'updateVersionFiles'], {async: true},
          function () {
      ...
      task('definePackage', self.prereqs, function () {
        var version = getPackageVersionNumber()
          , t;
    ...
    task('publish', self.prereqs.concat(['npm:fetchTags', 'npm:getCurrentBranch', 'npm:version',
