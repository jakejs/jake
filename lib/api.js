...
var api = new (function () {
  ...
  /**
    ...
    rule('.o', '.c', ['util.h'], function () {
      var cmd = util.format('gcc -o %s %s', this.name, src);
      jake.exec([cmd], function () {
        complete();
      }, {printStdout: true});
    }, { async : true });
   ...
   */
  this.rule = function (pattern, source, prereqs, action, opts) {
    var args = Array.prototype.slice.call(arguments);
    jake.currentNamespace.rules[pattern] = new jake.Rule({
      args: args
