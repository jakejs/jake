...
var api = new (function () {
  ...
  /**
    ...
    `
    @param {String} objSuffix The suffix name of the objective
    @param {String} srcSuffix The suffix name of the objective
    @param {Array} [prereqs] Prerequisites to be run before this task
    @param {Function} [action] The action to perform for this task
    @param {Object} [opts]
      @param {Boolean} [opts.asyc=false] Perform this task asynchronously.
   ...
   */
  this.rule = function (objSuffix, srcSuffix, prereqs, action, opts) {
    var args = Array.prototype.slice.call(arguments);
    jake.currentNamespace.rules[objSuffix] = new jake.Rule({
      args: args
